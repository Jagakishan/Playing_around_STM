...
Being honest, those were some lame functions. If you're about to use I2C practically, use functions HAL_I2C_MemREAD() and HAL_I2C_MemWRITE() functions. Simpler and easy to understand. 
Well suited to read and write values to and from registers inside sensors or other slave devices.
