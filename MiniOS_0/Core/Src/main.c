...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
UART_buffer buf1={0};	//buf1 is a UART_Buffer structure defined in main.h file. Same for all structures below.
